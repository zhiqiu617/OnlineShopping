	...
	<div class="container">
		<div class="login_body l_clear">
					...
					<form name="login" method="post" action="Loginform">
						...
						<div class="b_clear">
							<label for="auth_code" class="b_clear">验证码</label> <input
								type="text" name="authcode" id="auth_code" class="l_float"
								maxlength="4">
							<script src="js/gVerify.js">	
							</script>
							<div class="auth_code l_float" id="v_container" name="verifyCode"
						...
						<div class="b_clear submit">
							...
							<input type="button" name="l_submit"
								onclick="login_submit()" class="l_float"
								value="登录" /> <input type="button"
								onclick="window.location.href('register.jsp')" class="r_float"
								value="注册" />
			...
			<div class="login_ad l_float" id="AdImg">
				<a href="shoppingDetail.jsp">查看详情</a>
			</div>
		</div>
		<div class="footer">
			<p>
