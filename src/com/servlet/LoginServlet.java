		 ...
		 userService us=new userService();
	       ...
	       if(us.loginUser(user)!=null){
	    	   ...
	    	   System.out.println("��¼�ɹ�");
				...
				out.print("<script language='javascript'>alert('登录成功');window.location.href='./shoppingIndex.jsp';</script>");
	       }
	       else {
	    	   PrintWriter out=response.getWriter();
				out.print("<script language='javascript'>alert('登录错误');window.location.href='./login.jsp';</script>");
	       }
			//String forward = "";
